...
int main(void)
{
  ...
  double z[10] = {50.45,50.967,51.6,52.106,52.492,52.819,53.433,54.007,54.523,54.99};	
  ...
  p_n    =         10000;	// Initial estimate of variance.
